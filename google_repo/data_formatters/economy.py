...
class EconomyFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ('Days_from_start', DataTypes.REAL_VALUED, InputTypes.ID),
      ('Date', DataTypes.DATE, InputTypes.TIME),
      ('Open_SP500', DataTypes.REAL_VALUED, InputTypes.TARGET),
      ...
      ('Country', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT)
  ]
  ...
  def split_data(self, df, valid_boundary=2018, test_boundary=2020):
    ...
    test = df.loc[(index >= test_boundary) & (index < 2022)]
